...
public class MatchableRuleTest {
    ...
    public void knowsWhenMatches() {
        ...
        rule = new MatchableRule("org.foo.*", "jarjar.org.foo.@1");

        matches("org.xxx.yyy", "org.xxx.yyy");
        matches("org.foo", "jarjar.org.foo");
        ...
        //matches("org.foo2,org.bar1,org.foo1", "jarjar.org.foo2,org.bar1,jarjar.org.foo1");
        matches("org.foo,org.bar1,org.foo", "jarjar.org.foo,org.bar1,jarjar.org.foo");
        //matches("org.foo$1,org.foo_x hey", "jarjar.org.foo$1,jarjar.org.foo_x hey");

        matches("META-INF/services/org.foo.test", "META-INF/services/jarjar.org.foo.test");
        matches("org/foo/test/spring-dwr-3.0.xsd", "org/foo/test/spring-dwr-3.0.xsd");
        matches("org/foo/spring-dwr-3.0.xsd", "jarjar/org/foo/spring-dwr-3.0.xsd");
        matches("/org/foo/test/spring/spring-dwr-3.0.xsd", "/org/foo/test/spring/spring-dwr-3.0.xsd");
        matches("ffff=org/foo/spring-dwr-3.0.xsd", "ffff=jarjar/org/foo/spring-dwr-3.0.xsd");

        matches("<dd>ddddd</dd><zz>zzzz</zz><validator-class>org.foo.JstlCoreTLV</validator-class><yy>yyyy</yy>",
                "<dd>ddddd</dd><zz>zzzz</zz><validator-class>jarjar.org.foo.JstlCoreTLV</validator-class><yy>yyyy</yy>");
        String output = rule.replace("<dd>ddddd</dd><zz>zzzz</zz><validator-class>org.foo.JstlCoreTLV</validator-class><yy>yyyy</yy>");
